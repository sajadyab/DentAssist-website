...
<div class="container-fluid bills-page patients-add-page">
    <div class="bills-queue-header">
        <div class="row align-items-center bills-queue-header-inner">
            <div class="col-12 col-lg-8">
                <h2 class="mb-2 fw-bold">
                    <i class="fas fa-user-plus me-2 opacity-90" aria-hidden="true"></i>Add New Patient
                </h2>
                <p class="mb-0 opacity-90">Create a complete patient profile and generate login credentials in one flow.</p>
            </div>
            <div class="col-12 col-lg-4 mt-3 mt-lg-0 d-flex justify-content-center justify-content-lg-end patient-add-back-wrap">
                <a href="index.php" class="btn btn-secondary patient-add-back-btn">
    ...
    <div class="card bills-dash-section-card form-card patient-add-form-card">
        ...
        <div class="card-body">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end gap-2 patient-add-actions">
                    <button type="submit" name="save_and_continue" class="btn btn-primary patient-add-action-btn">
                        Save & Continue
                    </button>
                    <button type="submit" class="btn btn-success patient-add-action-btn">
                        Save Patient
                    </button>
                    <a href="index.php" class="btn btn-secondary patient-add-action-btn">Cancel</a>
                </div>
            </form>
        </div>
    </div>
